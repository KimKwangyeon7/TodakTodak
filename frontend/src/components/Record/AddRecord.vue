      ...
      fnAdd() {
        ...
        createNewVoice(
          ...
          (response) => {
            ...
            const createdRecordId = response.data.id; // Assuming the response data has the id of the created record
            ...
            getUser(
              ...
              (response) => {
                ...
                this.$router.push({ path: '/records/trainer' }).catch(console.error);
              },
              (error) => {
